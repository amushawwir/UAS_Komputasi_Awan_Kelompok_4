                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('daftarkan') }}" enctype="multipart/form-data" id="myForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="asalSekolah" type="text" class="form-control{{ $errors->has('asalSekolah') ? ' is-invalid' : '' }}" name="asalSekolah" value="{{ old('asalSekolah') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pendidikan_ayah" type="text" class="form-control{{ $errors->has('pendidikan_ayah') ? ' is-invalid' : '' }}" name="pendidikan_ayah" value="{{ old('pendidikan_ayah') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pendidikan_ibu" type="text" class="form-control{{ $errors->has('pendidikan_ibu') ? ' is-invalid' : '' }}" name="pendidikan_ibu" value="{{ old('pendidikan_ibu') }}" required autofocus>
